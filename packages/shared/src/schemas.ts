...
export const CreateCredentialBaseSchema = z.object({
...
export const CreateCredentialSchema = CreateCredentialBaseSchema.refine(
  (data) => {
...
export const UpdateCredentialSchema = CreateCredentialBaseSchema.partial();
